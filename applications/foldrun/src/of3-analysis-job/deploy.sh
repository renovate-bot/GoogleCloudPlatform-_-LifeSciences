...
# Deploy OF3 Prediction Analyzer as Cloud Run Job
...
JOB_NAME=${JOB_NAME:-of3-analysis-job}
...
echo "================================================"
echo "Deploying OF3 Analysis Job to Cloud Run"
echo "================================================"
...
echo "  of3_analyze_job_parallel(job_id='your-job-id')"
echo "================================================"
