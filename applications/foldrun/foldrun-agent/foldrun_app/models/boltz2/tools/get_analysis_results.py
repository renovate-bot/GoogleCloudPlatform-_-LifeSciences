...
"""Tool for retrieving BOLTZ2 analysis results from GCS."""
...
class BOLTZ2GetAnalysisResultsTool(BOLTZ2Tool):
    """Retrieves BOLTZ2 analysis results from Cloud Run Jobs."""
    ...
    def run(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "not_found",
                "message": f"No analysis found for job {job_id}. Run boltz2_analyze_job_parallel first.",
                "error": str(e),
            }
